    ...
    <div id="unidade-I-tematica-II">
      ...
      <div class="columns is-vcentered">
        ...
        <div class="column">
          <div class="is-left">
            ...
            análise crítica só é possível quando se entende o significado da
            mídia na sociedade e a importância da liberdade de expressão. Também
            fazem parte da leitura competente o entendimento sobre como circulam
            as informações na grande mídia e nos diversos ambientes que compõem
            a internet, como as mídias sociais, bem como a comunicação de
            conteúdo patrocinado e influenciadores.
          </div>
        </div>
      </div>
        ...
        <div class="columns is-vcentered">
          ...
          <div class="column">
            <div class="dialog-box is-left">
              ...
              <strong>qualidade da informação</strong> encontrada. Você confere
              as informações que recebe? Em que sites você costuma buscar as
              informações?
            </div>
          </div>
        </div>
      ...
      <div class="columns is-vcentered">
        ...
        <div class="column">
          <div class="is-left">
            ...
            imagens, dados e áudio, entendendo e adequando as suas linguagens a
            cada formato de mídia.
          </div>
        </div>
      </div>
      <hr />
      ...
      <div class="block-bordered">
        <div class="columns is-vcentered">
          <div class="column">
            <div class="dialog-box is-right">
              Que <strong>conteúdos</strong> os <strong>alunos</strong> de vocês
              <strong>produzem</strong> na Internet? Que tal uma
              <strong>roda de conversa</strong> sobre esse assunto?
            </div>
          </div>
          <div class="column is-3">
            <figure>
      ...
      <div class="columns is-vcentered">
        ...
        <div class="column">
          <div class="is-left">
            ...
            construção da consciência crítica, não como o centro das atividades
            cotidianas. A preservação da privacidade e a compreensão de sua
            importância fazem parte deste processo participativo.
          </div>
        </div>
      </div>
      <div class="block-bordered">
        <div class="columns is-vcentered">
          ...
          <div class="column">
            <div class="dialog-box is-left">
              ...
              <strong>participando das mídias</strong> ? Como seria interessante
              saber como eles se percebem e são críticos em relação a isso?
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="columns is-vcentered">
          <div class="column">
            <div class="dialog-box is-right">
              ...
              <strong>competência</strong> podemos
              <strong>desenvolver</strong> para <strong>discutir</strong> todas
              essas <strong>temáticas</strong> com nossos alunos?
            </div>
          </div>
          <div class="column is-3">
            <figure>
      ...
      <p>
        ...
        viabilizar a construção destas competências nos alunos?
      </p>
      <p>
        A Comunidade Europeia e, de forma cada vez mais consistente, também os
        pesquisadores brasileiros (TAROUCO, 2019), têm utilizado o framework
        DigCompEdu para categorizar as competências digitais dos professores. O
        instrumento organiza-se em seis áreas (REDECKER, 2017):
      </p>
        ...
        <div class="columns is-multiline is-fill-vertical">
          <div class="column is-6 mb-2">
            <div class="card is-grey">
              ...
              <div class="card-header">
                <div class="card-header-title">Engajamento Profissional</div>
              </div>
              <div class="card-content">
          ...
          <div class="column is-6 mb-2">
            <div class="card is-grey">
              ...
              <div class="card-header">
                <div class="card-header-title">Recursos Digitais</div>
              </div>
              <div class="card-content">
                O professor cria, compartilha e fornece recursos digitais em
                rede;
              </div>
            </div>
          </div>
          <div class="column is-6 mb-2">
            <div class="card is-grey">
              ...
              <div class="card-header">
                <div class="card-header-title">Ensinar e Aprender</div>
              </div>
              <div class="card-content">
                Gerenciamento e organização das tecnologias digitais no ensino e
                na aprendizagem;
              </div>
            </div>
          </div>
          <div class="column is-6 mb-2">
            <div class="card is-grey">
              ...
              <div class="card-header">
                <div class="card-header-title">Avaliação da aprendizagem</div>
              </div>
              <div class="card-content">
                Utilização das tecnologias digitais para a avaliação da
                aprendizagem;
              </div>
            </div>
          </div>
          ...
          <div class="column is-6 mb-2">
            <div class="card is-grey">
              ...
              <div class="card-header">
                <div class="card-header-title">
                  Buscar a competência digital dos alunos
                </div>
              </div>
              <div class="card-content">
                O professor cria condições para a utilização criativa, crítica e
                responsável da internet para informação, comunicação, produção
                de conteúdos, bem-estar e resolução de problemas.
              </div>
            </div>
          </div>
        </div>
      ...
      <p>
        Claro que o desenvolvimento destas competências possui gradações,
      ...
      <p>
        O <strong>professor da Educação Básica</strong> precisa assumir
      ...
      <p>
        O <strong>professor</strong> deve <strong>incentivar</strong> uma
        cultura de <strong>aprendizagem contínua</strong> que coloque as mídias
        digitais e o conhecimento como elementos profundamente relacionados, em
        evolução contínua. O objetivo é criar uma cultura de crítica saudável,
        interessada e comprometida com a cidadania, dentro de uma compreensão
        ampla das tecnologias digitais como fundamentais nesta construção.
      </p>
      <p>
        ...
        dos conteúdos abordados é um bom começo. Porém é necessário abrir espaço
        para a discussão e a compreensão do cotidiano dos alunos, onde as
        tecnologias digitais inserem-se em contextos e situações diversas
        daquelas do professor.
      </p>
      <p>
        A aprendizagem significativa deve ser perseguida pelos docentes,
        utilizando em aula, sempre que possível, dispositivos como o smartphone
  ...
  data() {
    return {
      ...
      challenge1: [
        {
          text:
            'Ensinando o uso dessas linguagens nos aspectos gramaticais da Língua Portuguesa. Assim, os alunos poderão se comunicar corretamente e serem melhor compreendidos.',
          value: '1'
        },
        {
          text:
            'Mostrando a necessidade de escutar atentamente as explicações orais sobre os conteúdos escolares dadas pelos professores. Assim, os alunos poderão ter melhor desempenho nas avaliações.',
          value: '2'
        },
        {
          text:
            'Estimulando o uso dessas diferentes linguagens e mídias digitais. Assim, os alunos poderão compartilhar informações, experiências em diferentes contextos e produzir sentidos que levem ao diálogo, à resolução de conflitos e à cooperação.',
          value: '3'
        },
        {
          text:
            'Orientando a produção de textos escritos e a exercitação dos conteúdos escolares. Assim, os alunos conseguirão memorizar as  informações apresentadas na escola.',
          value: '4'
        }
      ],
      challenge2: [
        {
          text:
            'Orientando os alunos a não lerem toda e qualquer informação que receberem nas diversas redes sociais e mídias digitais. O importante é priorizar os livros didáticos e conteúdos escolares.',
          value: '1'
        },
        {
          text:
      ...
      challenge3: [
        {
          text: 'Uma biblioteca com muitos livros didáticos impressos.',
          value: '1'
        },
        {
          text: 'Laboratório de informática ou robótica educacional.',
          value: '2'
        },
        {
        ...
        {
          text: 'Tablets e computadores na sala de aula.',
          value: '4'
        },
        {
          text: 'Salas de aula com quadro para escrita.',
          value: '5'
        },
        {
